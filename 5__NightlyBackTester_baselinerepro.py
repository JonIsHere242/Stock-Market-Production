...
class StockSniperStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.trade_recorder = TradeRecorder('Data/TradeHistory_baselinerepro.parquet')
    ...
    def process_buy_candidates(self, buy_candidates, current_date, verbose=False):
        ...
        if False and buy_candidates and current_date == self.last_trading_date:  # baseline-repro: live-signal export DISABLED
            if verbose:
