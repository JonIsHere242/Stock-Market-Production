...
class StockSniperStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.trade_recorder = TradeRecorder('trade_history_sweep.parquet')  # SWEEP: redirect, do NOT clobber live trade_history.parquet
    ...
    def execute_buy_with_bracket(self, data, size, current_date):
        ...
        # SWEEP: trail % is read from env SWEEP_TRAIL (default 3.0 == baseline); TP held at 20 to isolate the trail.
        take_profit_percent = float(os.environ.get('SWEEP_TP', '20'))
        trailing_stop_percent = float(os.environ.get('SWEEP_TRAIL', '3.0'))
        ...
        if bracket_orders:
            ...
            # update_buy_signal(symbol, current_date, current_price, data.UpProbability[0])  # BASELINE-EXITS: neutralized (writes _Buy_Signals.parquet; not used by sim P&L)
