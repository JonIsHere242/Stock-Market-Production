...
ROOT = "Data/_refit_w2"            # WINDOW 2: independent OOS period
ENS = "Data/_ensemble_w2"
os.makedirs(ENS, exist_ok=True)
BACKTESTER = "5__NightlyBackTester_oosvalidate.py"
CUTOFF = "2025-06-30"              # train through Jun 2025 -> OOS = Jul-Oct 2025
...
# ---- Phase D: aggregate ----
OOS = ["2025-07", "2025-08", "2025-09", "2025-10"]   # WINDOW 2 OOS months
