...
# ── Book sizing ─────────────────────────────────────────────────────────────────
TARGET_BOOK_SIZE = 8   # widened 4->8 (2026-06-08): book-size sweep found ~8 the robust
                       # risk-adjusted sweet spot on two independent prediction paths
                       # (Data/_parallel*). NOTE: broker PositionSizer (9_SuperFastBroker
                       # line ~73, max_positions) must be set to 8 to actually fill 8.
