...
class AsyncFastExecutor:
    ...
    def __init__(self, host='127.0.0.1', port=7496, client_id=99,
        ...
        self.position_sizer = PositionSizer(
            ...
            max_positions=8   # widened 5->8 (2026-06-08): matches the 8-name book
                              # (MacroFilter TARGET_BOOK_SIZE=8). 90% working capital /8
                              # = ~11.25% per name. Book-size sweep sweet spot.
        )
