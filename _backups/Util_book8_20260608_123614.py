...
STRATEGY_PARAMS = {
    ...
    'max_positions': 8,                 # Maximum concurrent positions (widened 4->8 2026-06-08; book-size sweep sweet spot). NOTE: 9_SuperFastBroker sizes from its OWN hardcoded PositionSizer(max_positions=...) ~line 73 — change that too to fill 8 live.
