...
def find_optimal_clusters(scaled_correlation, min_clusters=4, max_clusters=19):
    """Find optimal number of clusters using silhouette score.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--min-clusters', type=int, default=4, 
                      help='Minimum number of clusters to use (default: 4)')
    parser.add_argument('--max-clusters', type=int, default=19,
                      help='Maximum number of clusters to evaluate (default: 19)')
